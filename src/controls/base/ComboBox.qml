...
T.ComboBox {
    ...
    property color hoverColor: AppTheme.theme === 'Dark' ? Qt.rgba(68 / 255, 68 / 255, 68 / 255, 1) : Qt.rgba(251 / 255, 251 / 255, 251 / 255, 1)
    property color disableColor: AppTheme.theme === 'Dark' ? Qt.rgba(59 / 255, 59 / 255, 59 / 255, 1) : Qt.rgba(252 / 255, 252 / 255, 252 / 255, 1)
    ...
    enabled: !disabled
    delegate: BaseControls.ItemDelegate {
    ...
    contentItem: T.TextField {
        ...
        color: {
            if (control.disabled) {
                return AppTheme.theme === 'Dark' ? Qt.rgba(131 / 255, 131 / 255, 131 / 255, 1) : Qt.rgba(160 / 255, 160 / 255, 160 / 255, 1);
            }
            return AppTheme.theme === 'Dark' ? Qt.rgba(255 / 255, 255 / 255, 255 / 255, 1) : Qt.rgba(27 / 255, 27 / 255, 27 / 255, 1);
        }
    ...
    background: Rectangle {
        implicitWidth: 140
        implicitHeight: 32
        border.color: AppTheme.theme === 'Dark' ? "#505050" : "#DFDFDF"
        border.width: 1
